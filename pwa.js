...
const cacheName = 'LAWeek4KatelynAxelson_appstudio-2021-02-24 14:41:16.366990'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4KatelynAxelson_appstudio'.length) === 'LAWeek4KatelynAxelson_appstudio') {
